...
app.layout = html.Div(children=[
    ...
    dcc.RangeSlider(
        ...
        max=max_payload,
        step=1000,
        marks={int(i): f'{int(i)}' for i in range(int(min_payload), int(max_payload)+1, 2500)},
...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        ...
        fig = px.pie(counts, names='class', values='count', title=f'Success vs Failure for {selected_site}')
    return fig
